...
import static com.nix.zhylina.constants.Constants.SQL_ADD_USER;
import static com.nix.zhylina.constants.Constants.SQL_REMOVE_USER;
...
import static com.nix.zhylina.constants.Constants.SQL_FIND_BY_EMAIL;
import static com.nix.zhylina.constants.Constants.SQL_FIND_BY_ID_USER;
import static com.nix.zhylina.constants.Constants.SQL_FIND_BY_LOGIN;
import static com.nix.zhylina.constants.Constants.SQL_SELECT_USER;
import static com.nix.zhylina.constants.Constants.SQL_UPDATE_USER;
...
public class JdbcUserDao extends GenericJdbcDao<User> implements UserDao {
    ...
    public void create(User entity) {
        try {
            preparedStatement = executeStatement(SQL_ADD_USER);
            ...
            throw new UserDataProcessingException(ERROR_CREATION_TUPLE, sqlException);
        }
    }
    ...
    public void update(User entity) {
        try {
            preparedStatement = executeStatement(SQL_UPDATE_USER);
            substitutionOfValuesInQuery(entity);
    ...
    public void remove(User entity) {
        try {
            preparedStatement = executeStatement(SQL_REMOVE_USER);
            preparedStatement.setString(1, (entity.getEmail()));
            closeUpdate();
            LOG.info("Database entry removed: " + entity);
        } catch (SQLException sqlException) {
            throw new UserDataProcessingException(ERROR_REMOVING_TUPLE, sqlException);
        }
    }
    ...
    public List<User> findAll() {
        ...
        try {
            preparedStatement = executeStatement(SQL_SELECT_USER);
            ...
            throw new UserDataProcessingException(ERROR_SEARCH_TUPLE, sqlException);
        } finally {
    ...
    public User findById(Long id) {
        ...
        return findUser(SQL_FIND_BY_ID_USER, id.toString());
    }
    ...
    public User findByLogin(String login) {
        ...
        return findUser(SQL_FIND_BY_LOGIN, login);
    }
    ...
    public User findByEmail(String email) {
        ...
        return findUser(SQL_FIND_BY_EMAIL, email);
    }
