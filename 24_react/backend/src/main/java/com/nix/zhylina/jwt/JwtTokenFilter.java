...
public class JwtTokenFilter extends GenericFilterBean {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            ...
            Map<String, String> errorsList = Map.of(TokenConstants.ERROR_TOKEN, e.getMessage());

            response.getWriter().write(CustomErrorHandling.jsonObject(new ApiError(HttpStatus.UNAUTHORIZED, Constants.CONST_ERRORS, errorsList)));
        }
    }
}
