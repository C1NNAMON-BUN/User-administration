 ...
 * {@link UserDaoService#remove(User)}, as well as editing users
 * {@link EditUsersController} and the {@link UserDaoService#update(User)} method. BUT
 * also the ability to go to the page for creating a new user with
 * using {@link AddUsersController} and method
 * {@link UserDaoService#create(User)}.
